"""
Script to list all courses in the database using direct SQL
"""
import sys
import os
...
def list_all_courses():
    """
    List all courses in the database using direct SQL
    """
    try:
        with engine.connect() as conn:
            # Get table names first to confirm the correct table name
