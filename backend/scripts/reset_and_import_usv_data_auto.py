"""
Script to automatically reset the database and import only data from orar.usv.ro
This script will:
...
def backup_database():
    ...
    try:
        ...
        backup_command = f"pg_dump -h {db_host} -U {db_user} -d {db_name} -f {backup_path}"
        ...
        if result == 0:
            ...
            print(f"Database backup failed with exit code: {result}")
            return False
    ...
    try:
        ...
        for professor in professors_data:
            ...
            try:
                ...
                print(f"Error importing professor {full_name}: {e}")
    ...
    try:
        ...
        for room in rooms_data:
            ...
            try:
                ...
                print(f"Error importing room {name}: {e}")
    ...
    try:
        ...
        for faculty in faculties_data:
            ...
            try:
                ...
                print(f"Error importing faculty {name}: {e}")
    ...
    try:
        ...
        for subgroup in subgroups_data:
            ...
            try:
                ...
                print(f"Error importing group {name}: {e}")
...
async def main():
    print("=== DATABASE RESET AND IMPORT SCRIPT (AUTOMATIC MODE) ===")
    ...
    if not backup_success:
        print("WARNING: Failed to create database backup. Proceeding anyway...")
