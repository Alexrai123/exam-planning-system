"""
Script to add Asistenta Medicala Generala Year 4 courses to the database
"""
import sys
import os
...
def add_amg_year4_courses():
    """
    Add Asistenta Medicala Generala Year 4 courses to the database
    """
    try:
        # Define AMG Year 4 courses from the image (without numbers)
        amg_year4_courses = [
            ...
            {"name": "Ingrijirea pacientului geriatric cu afectiuni neurologice - Accidentul vascular ischemic si hemoragic", "year": 4, "semester": 1},
            {"name": "Ingrijirea pacientului geriatric cu afectiuni neurologice - B. Parkinson", "year": 4, "semester": 1},
            {"name": "Ingrijirea pacientului geriatric cu afectiuni neurologice - Neuropatia periferica", "year": 4, "semester": 1},
            {"name": "Ingrijirea pacientului geriatric cu afectiuni neurologice - Scleroza multipla. B. Alzheimer", "year": 4, "semester": 1},
            
            # Second semester courses
            {"name": "Ingrijirea pacientului geriatric cu afectiuni cardio-vasculare", "year": 4, "semester": 2},
            {"name": "Ingrijirea pacientului geriatric cu afectiuni reumatologice la pacientii geriatrici - Artrita reumatoida", "year": 4, "semester": 2},
            {"name": "Ingrijirea pacientului geriatric cu afectiuni reumatologice la pacientii geriatrici - Artropatiile seronegative", "year": 4, "semester": 2},
            {"name": "Ingrijirea pacientului geriatric cu afectiuni articulare degenerative", "year": 4, "semester": 2},
            {"name": "Ingrijirea pacientului geriatric cu afectiunilor gastro-enterologice", "year": 4, "semester": 2},
        ...
        with engine.connect() as conn:
            ...
            result = conn.execute(text(
                ...
                AND (
                    ...
                    OR name LIKE 'Ingrijirea%'
                    OR name LIKE 'Procesul%'
                    OR name LIKE 'Examenul%'
                    OR name LIKE 'Modalitatile%'
                )
                GROUP BY year
                ORDER BY year
                """
