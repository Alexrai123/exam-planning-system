"""
Script to add Asistenta Medicala Generala Year 3 courses to the database
"""
import sys
import os
...
def add_amg_year3_courses():
    """
    Add Asistenta Medicala Generala Year 3 courses to the database
    """
    try:
        # Define AMG Year 3 courses from the image (without numbers)
        amg_year3_courses = [
            # First semester courses
            {"name": "Introducere in nursing-ul bolilor chirurgicale; evaluarea bolnavului chirurgical", "year": 3, "semester": 1},
            ...
            {"name": "Bolile infecto-contagioase: scarlatina, varicela, rubeola, toxinfectii alimentare, hepatita virala tip A. Interventiile nursei", "year": 3, "semester": 2},
            {"name": "Relatia mama-copil. Ingrijirea medicala a mamei si copilului. Asistenta de crestere. Calitatile vechi in medicina", "year": 3, "semester": 2},
